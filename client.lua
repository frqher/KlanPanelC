...
function on_Group_LeaderClick()
	if guiCheckBoxGetSelected(Group_Leader_Checkbox) then
		...
		if GroupName == "" then
			exports.GTIhud:dm("Klan ismini giriniz ! ", 0, 255, 0, true)
		elseif AccountName == "" then
			exports.GTIhud:dm("Hesap ismini giriniz ! ", 0, 255, 0, true)
		elseif AccountPassword == "" then
		exports.GTIhud:dm("Hesap şifrenizi giriniz ! ", 0, 255, 0, true)
		else
...
--                     exports.GTIhud:dm("$"..fiyat.." Karşılığında "..name.." Satın Alındı ! ", 0, 255, 0, true)
--                     guiGridListClear(EnvanterList)
--                     triggerServerEvent("Envanter:Yenile", localPlayer)
--                     else
--                         exports.GTIhud:dm(name.." Satın almak için yeterli paraya sahip değilsiniz !", 255, 0, 0, true)
--                     end
--                 end
--             end
--         end
...
--                     end, 10000, 1)
--                     exports.GTIhud:dm("Testin bitiş süresi 10 saniye ! ", 0, 255, 0, true)
	...
	elseif source == GroupBank_Deposit_Button then
		...
		if money > 0 then
			if money >= 1000 then
				...
				exports.GTIhud:dm("#04B4AE[Klan Bankası] #FFFF00Klan bankasına minimum 1000 ALTIN yatıra bilirsiniz.", 255, 0, 0,true)
			end
		end
